<?php
	...
	if (@$classes['tools']->check($_POST['username']) && @$classes['tools']->check($_POST['password'])) {
		$classes['users']->login_user($db, $_POST['username'], $_POST['password'], $filename);
	}
	
	if (isset($_REQUEST['logout'])) {
		$classes['users']->logout_user($filename);
	}
...
<html>
	...
	<body>
		...
		<div id="maincontent">
			...
			<?php
				if ($userinfo) {
					echo 'You are already logged in! (' . $userinfo['name'] . ')<br />';
